...
foreach ($server_group as $k=>$v)
{
	...
	$query_payer_guid= "select creation_time as guid from test.pay_orders where pay_type = '$k'  ";
	...
	$query_payer_name = "select guid,name from {$v["main"]}.Player_Character where guid in $guid_str ";
	...
	{
		$query_update = "update test.pay_orders set `uid`='{$nv["name"]}' where pay_type = '$k' and creation_time = {$nv["guid"]}";
